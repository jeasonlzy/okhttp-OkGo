package com.lzy.okhttpgo.cookie.store;
...
public class PersistentCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "okhttpgo_cookie";        //cookie使用prefs保存
    ...
    public PersistentCookieStore() {
        cookiePrefs = OkHttpGo.getContext().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
